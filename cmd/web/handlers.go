...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.MinChars(form.Password, 8), "password", "This must be at least 8 chars long")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Email), "email", "This fieldcannot be blank")
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This field must be a valid email address")
	form.CheckField(validator.NotBlank(form.Password), "password", "This fieldcannot be blank")
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), "flash", "Your password has been changed")
